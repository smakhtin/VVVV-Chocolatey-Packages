...
$currentDir = 'vvvv_45beta29.2_x64'
Install-ChocolateyZipPackage vvvv "http://vvvv.org/sites/all/modules/general/pubdlcnt/pubdlcnt.php?file=http://vvvv.org/sites/default/files/vvvv_45beta29.2_x64.zip&nid=96038" $installPath
